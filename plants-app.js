...
function App(){
  ...
  // ── Render ──
  return h("div",{style:{fontFamily:"'Poppins',sans-serif",background:"#fafaf7",minHeight:"100vh",color:"#2c2c2c",paddingBottom:isMobile?"calc(64px + env(safe-area-inset-bottom,0px))":"0",paddingTop:isMobile?"0":"140px"}},
      ...
      h("div",{style:{maxWidth:900,margin:"0 auto"}},
        (activeTab==="plants"||activeTab==="mix")&&h("div",{style:{padding:"10px 20px 0"}},
          h("div",{style:{position:"relative",marginBottom:8,display:"flex",gap:8,alignItems:"center"}},
            h("input",{value:search,onChange:function(ev){setSearch(ev.target.value);},placeholder:loading?"Loading\u2026":"Search "+plants.length+" Massachusetts native plants\u2026",style:{flex:1,padding:"10px 44px 10px 18px",border:"1.5px solid #e0ddd5",borderRadius:10,fontFamily:"inherit",fontSize:15,background:"white",outline:"none",color:"#2c2c2c"}}),
            ...
            activeTab==="plants"&&h("button",{onClick:function(){setActiveTab("mix");},style:{display:"inline-flex",alignItems:"center",gap:6,padding:"8px 16px",borderRadius:10,border:"2px solid #2e5339",background:"white",color:"#2e5339",cursor:"pointer",fontFamily:"inherit",fontSize:13,fontWeight:500,whiteSpace:"nowrap"}},"\ud83c\udf31 Design a habitat patch")
          ),
          isMobile?h("div",{style:{paddingBottom:10}},
            ...
            h("div",{style:{display:"flex",gap:6,alignItems:"center",flexWrap:"wrap",paddingBottom:2}},
              ...
              h("span",{style:{position:"relative",display:"inline-flex"}},
                ...
                openPop==="more"&&h("div",{style:{position:"absolute",top:"calc(100% + 6px)",right:0,left:"auto",zIndex:300,background:"white",border:"1px solid #e0ddd5",borderRadius:12,padding:"16px 18px",boxShadow:"0 6px 24px rgba(0,0,0,0.10)",minWidth:340,maxWidth:"min(520px,90vw)",maxHeight:"80vh",overflowY:"auto"}},
                  h("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}},
                      ...
                      h("div",{style:{display:"flex",flexDirection:"column",gap:10,marginBottom:14}},
                        [{title:"\ud83e\udd8c Deer",key:"deerLevel",setFn:setDeerLevel,val:filters.deerLevel},{title:"\ud83d\udc07 Rabbit",key:"rabbitLevel",setFn:setRabbitLevel,val:filters.rabbitLevel},{title:"\ud83d\udc2d Vole",key:"voleLevel",setFn:setVoleLevel,val:filters.voleLevel}].map(function(row){
                          return h("div",{key:row.key,style:{display:"flex",alignItems:"center",gap:8}},
                            ...
                            h("div",{style:{display:"flex",gap:5}},[{v:null,l:"Any"},{v:"high",l:"Resistant"},{v:"mod",l:"Highly resistant"}].map(function(o){return h("button",{key:String(o.v),onClick:function(){row.setFn(o.v);},style:pill(row.val===o.v,row.val===o.v)},o.l);}))
                          );
                        })
                      )
                    ),
                    ...
                    h("div",{style:{gridColumn:"1 / -1"}},
                      ...
                      h("div",{style:{display:"flex",flexWrap:"wrap",gap:12}},
                        ...
                        h("label",{style:{display:"flex",alignItems:"center",gap:6,cursor:"pointer",fontSize:13}},h("input",{type:"checkbox",checked:filters.concerns.indexOf("nospread")>=0,onChange:function(){togCx("nospread");},style:{accentColor:"#2e5339"}}),"\ud83dude\ufe0f No spreaders")
                      )
                    )
                  ),
                  h("div",{style:{borderTop:"1px solid #e0ddd5",marginTop:14,paddingTop:12,display:"flex",justifyContent:"flex-end"}},
    ...
    h("div",{style:{maxWidth:900,margin:"0 auto",padding:isMobile?"0 16px 120px":"0 20px 80px"}},
      ...
      !loading&&!error&&(
        ...
        activeTab==="mix"?h("div",null,
          h("div",{style:{background:"white",border:"1px solid #e0ddd5",borderRadius:12,padding:"14px 18px",marginBottom:14,display:"flex",alignItems:"center",gap:12}},
            h("div",{style:{fontSize:22,flexShrink:0}},"\ud83c\udf3f"),
            h("div",null,
              h("div",{style:{fontWeight:500,fontSize:14,marginBottom:3}},"A layered mix of the best plants for your site"),
              h("div",{style:{fontSize:13,color:"#888",lineHeight:1.5}},"Use the filters above to set your site conditions \u2014 sun, moisture, concerns \u2014 and the mix will draw from those results. "),
              h("div",{style:{fontSize:13,color:"#888",lineHeight:1.5}},"Structured in layers from canopy trees to groundcovers. Remove any plant you don\u2019t like or can\u2019t source and the next best option fills its spot. A mix of heights and types \u2014 including canopy trees \u2014 supports the most biodiversity and ecosystem function.")
            )
          ),
    ...
    // Mobile bottom nav
    isMobile&&h("div",{style:{position:"fixed",bottom:0,left:0,right:0,zIndex:200,background:"white",borderTop:"1px solid #e0ddd5",display:"flex",paddingBottom:"env(safe-area-inset-bottom,0px)"}},
      [
